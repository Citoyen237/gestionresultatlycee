"""
Django settings for gestionresultat project.
...
SECRET_KEY = 'django-insecure-plo^&d#i-owr^04y%u*7-wt4seb^e8%*je@n5o$x)@+s*6hvwx'
...
ROOT_URLCONF = 'gestionresultat.urls'
...
WSGI_APPLICATION = 'gestionresultat.wsgi.application'
